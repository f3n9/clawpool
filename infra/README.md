...
- `OPENCLAW_DEFAULT_CHANNEL_PLUGINS` (optional additive fallback list for extra bundled channel plugins such as `wecom`)
- `OPENCLAW_DEFAULT_CHANNEL_PLUGIN_DIRS` (optional override for extra bundled plugin discovery roots; defaults to `/opt/openclaw/extensions`)
